...
- Distributions: normal, exponential, cauchy, central limit theorem, heavy tailed, long-tailed, -at-tailed
- Divergent Thinking
- Divide and Conquer
- Division of Labor
...
- Le Chatelier's Principle: A system at equilibrium when changed moves to a new equilibrium will -end to partly counteract the change (The system always kicks back)
- Leverage
...
- Transformation
- Transparency
- Transtheoretical Model, aka Pochaskas Six Stage Model of Behavior Change ([see](https://en.-ikipedia.org/wiki/Transtheoretical_model)

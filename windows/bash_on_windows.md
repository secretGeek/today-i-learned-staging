...
The home folder is now stored at:
    ...
    C:\Users\user1\AppData\Local\Packages\CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc\LocalState\rootfs\home\user1
...
- [running gui apps from the linux subsystem for windows](../wsl/running_gui_apps_from_the_linux_subsystem_for_windows.md)
- [10 Linux GUI Apps to Run on Windows with WSL](../wsl/10_linux_gui_apps_to_run_on_windows_if_you_have_wsl.md)
